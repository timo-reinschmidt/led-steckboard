		...
		while (!validInput) {
			...
			if (sc.hasNextInt()) { // Es wird überprüft, ob die Eingabe eine ganze Zahl ist
				...
				if (number > 0) {
					...
					// System.out.println("Die Binärdarstellung der eingegebenen Zahl ist: " +
					// binaryString); -> zum testen gewesen

					// 3. LED's hinzufuegen wie lang die Binaer Zahl ist
					int binaryLength = binaryString.length();
					// System.out.println("Es werden " + binaryLength + " LEDs benoetigt."); -> zum
					// testen gewesen

					// 4.2
					int binaryLengthRounded = (binaryLength + 7) / 8 * 8; // Auf das nächste Vielfache von 8 aufrunden
					// System.out.println("Es werden " + binaryLengthRounded + " LEDs
					// hinzugefügt."); -> zum testen gewesen
